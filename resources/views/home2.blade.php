                ...
                <div class="row">
                    <div class="col-md-3 col-sm-3 col-lg-3">
                        <div class="mini-stat clearfix bx-shadow">
                            ...
                            <div class="mini-stat-info text-right text-muted">
                                <span class="counter">{{$deposits}}</span>
                                Total Deposits
                            </div>
                    ...
                    <div class="col-md-3 col-sm-3 col-lg-3">
                        <div class="mini-stat clearfix bx-shadow">
                            ...
                            <div class="mini-stat-info text-right text-muted">
                                <span class="counter">{{$depositsToday}}</span>
                                Today Deposits
                            </div>
                            {{--<div class="tiles-progress">
                                <div class="m-t-20">
                    ...
                    <div class="col-md-3 col-sm-3 col-lg-3">
                        <div class="mini-stat clearfix bx-shadow">
                            ...
                            <div class="mini-stat-info text-right text-muted">
                                <span class="counter">{{$depositsMonth}}</span>
                                This Month Deposits
                            </div>
                            {{--<div class="tiles-progress">
                                <div class="m-t-20">
                    ...
                    <div class="col-md-3 col-sm-3 col-lg-3">
                        <div class="mini-stat clearfix bx-shadow">
                            <span class="mini-stat-icon bg-warning"><i class="ion-social-usd"></i></span>
                            <div class="mini-stat-info text-right text-muted">
                                <span class="counter">{{$depositsSeven}}</span>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-lg-4">
                        <div class="mini-stat clearfix bx-shadow">
                            ...
                            <div class="mini-stat-info text-right text-muted">
                                <span class="counter">{{$salesSeven}}</span>
                                Last 7 Days Cash Sales
                            </div>
                            {{-- <div class="tiles-progress">
                                 <div class="m-t-20">
                                     <h5 class="text-uppercase">Orders <span class="pull-right">90%</span></h5>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-lg-4">
                        <div class="mini-stat clearfix bx-shadow">
                            ...
                            <div class="mini-stat-info text-right text-muted">
                                <span class="counter">{{$bricks}}</span>
                                Total Sold Bricks
                            </div>
                            {{--<div class="tiles-progress">
                                <div class="m-t-20">
                    ...
                    <div class="col-md-4 col-sm-4 col-lg-4">
                        <div class="mini-stat clearfix bx-shadow">
                            ...
                            <div class="mini-stat-info text-right text-muted">
                                <span class="counter">{{$bricksToday}}</span>
                                Today Bricks Sold
                            </div>
                            {{--<div class="tiles-progress">
                                <div class="m-t-20">
                    ...
                    <div class="col-md-4 col-sm-4 col-lg-4">
                        <div class="mini-stat clearfix bx-shadow">
                            ...
                            <div class="mini-stat-info text-right text-muted">
                                <span class="counter">{{$bricksSeven}}</span>
                                Last 7 Days Bricks Sold
                            </div>
                            {{--<div class="tiles-progress">
                                <div class="m-t-20">
                                    <h5 class="text-uppercase">Users <span class="pull-right">57%</span></h5>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-lg-4">
                        <div class="mini-stat clearfix bx-shadow">
                            <span class="mini-stat-icon bg-info"><i class="ion-social-usd"></i></span>
                            <div class="mini-stat-info text-right text-muted">
                                <span class="counter">{{$expenseSeven}}</span>
                                Last 7 Days Expense
                            </div>
                            {{--<div class="tiles-progress">
                                <div class="m-t-20">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-lg-4">
                        <div class="mini-stat clearfix bx-shadow">
                            <span class="mini-stat-icon bg-danger"><i class="ion-social-usd"></i></span>
                            <div class="mini-stat-info text-right text-muted">
                                <span class="counter">{{$dueToday}}</span>
                                Today Dues
                            </div>
                            {{--<div class="tiles-progress">
                                <div class="m-t-20">
                    ...
                    <div class="col-md-4 col-sm-4 col-lg-4">
                        <div class="mini-stat clearfix bx-shadow">
                            <span class="mini-stat-icon bg-warning"><i class="ion-social-usd"></i></span>
                            <div class="mini-stat-info text-right text-muted">
                                <span class="counter">{{$dueMonth}}</span>
                                This Month Dues
                            </div>
                            {{--<div class="tiles-progress">
                                <div class="m-t-20">
